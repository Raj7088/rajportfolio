export default function Clients() {
  const logos = [
    { src: "/tcs.png", name: "TCS" },
    { src: "/infosys.png", name: "Infosys" },
    { src: "/wipro.png", name: "Wipro" },
    { src: "/accenture.png", name: "Accenture" },
    { src: "/cognizant.png", name: "Cognizant" },
    { src: "/capgemini.png", name: "Capgemini" },
    { src: "/techmahindra.png", name: "Tech Mahindra" },
    { src: "/hcl.png", name: "HCL" }
  ];
